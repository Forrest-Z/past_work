...
class GlobalTrajectoryBuilder : public mapping::TrajectoryBuilderInterface {
 public:
  ...
  void AddSensorData(
    ...
    t0 = clock();
    //AddRangeData函数在 local_trajectory_builder.cc 文件中
    ...
    t1 = clock();
    std::cout << "----------AddSensorData->AddRangeData time = " <<(double)(t1 -t0) / CLOCKS_PER_SEC << std::endl;
    ...
    t3 = clock();
    std::cout << "----------AddSensorData->AddNode time = " <<(double)(t3 -t2) / CLOCKS_PER_SEC << std::endl;
