 ...
 * @version: 
 * @Author: luo
 * @Date: 2022-03-03 19:10:49
 * @LastEditors: luo
 * @LastEditTime: 2022-03-21 16:19:28
 */
/*
...
void LocalSlamResult2D::AddToPoseGraph(int trajectory_id,
  ...
  t1 = clock();
  // std::cout << "----------UpdateSubmap time = " <<(double)(t1 -t0) / CLOCKS_PER_SEC << std::endl;
  ...
  t2 = clock();
  // std::cout << "----------AddNode time = " <<(double)(t2 -t1) / CLOCKS_PER_SEC << std::endl;
}
