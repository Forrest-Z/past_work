...
LocalTrajectoryBuilder2D::AddAccumulatedRangeData(
  ...
  t1 = clock();
  std::cout << "----------AddAccumulatedRangeData->ScanMatch time = " <<(double)(t1 -t0) / CLOCKS_PER_SEC << std::endl; 
  ...
  // std::cout << "----------InsertIntoSubmap size = " << insertion_result->insertion_submaps.size() << std::endl; 
  t4 = clock();
  std::cout << "----------AddAccumulatedRangeData->InsertIntoSubmap time = " <<(double)(t4 -t3) / CLOCKS_PER_SEC << std::endl; 
...
LocalTrajectoryBuilder2D::InsertIntoSubmap(
  ...
  std::cout << "------InsertRangeData_size = " << insertion_submaps.size() << std::endl;
