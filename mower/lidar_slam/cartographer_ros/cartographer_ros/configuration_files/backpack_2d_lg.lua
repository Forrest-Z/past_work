...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians=math.rad(360.)
...
-- TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.probability_grid_range_data_inserter.miss_probability =0.42
...
POSE_GRAPH.optimization_problem.odometry_translation_weight= 8
