...
#ifndef SRC_GPPRIORFACTOR_H
#define SRC_GPPRIORFACTOR_H
...
namespace gp_lio{
    ...
    struct PriorTError{
        PriorTError(double t_x, double t_y, double t_z, double var)
        ...
        static ceres::CostFunction* Create(const double t_x, const double t_y, const double t_z, const double var)
        {
            return (new ceres::AutoDiffCostFunction<
                    PriorTError, 3, 3>(
                    new PriorTError(t_x, t_y, t_z, var)));
        }
